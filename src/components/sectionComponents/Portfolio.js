    ...
    return(
        <div>
            <div>
                ...
                <a href="https://vast-journey-10843.herokuapp.com/login"><img src={FiveStarLocal}/></a>
            ...
            <div>
                ...
                <a href="https://cleggatron.github.io/ClearSky/"><img src={ClearSky}/></a>
            ...
            <div>
                ...
                <a href="https://github.com/Cleggatron/Employee-Tracker"><img src={EmployeeTracker}/></a>
            ...
            <div>
                ...
                <a href="https://vast-everglades-18367.herokuapp.com/"><img src={NoteTaker}/></a>
            ...
            <div>
                ...
                <a href="https://cleggatron.github.io/RandomPasswordGenerator/"><img src={PasswordGenerator}/></a>
            ...
            <div>
                ...
                <a href="https://github.com/Cleggatron/TeamProfileGenerator"><img src={TeamProfileGenerator}/></a>
